...
if (strlen($_SESSION['bpmsaid'] == 0)) {
	...
	if (isset($_POST['submit'])) {
		...
		$query = mysqli_query($con, "update tblsalon set SalonAdminName ='$aname', MobileNumber='$mobno' where ID='$adminid'");
		if ($query) {
...
?>
	...
	<head>
		<title>MSMS | Saloon Admin Profile</title>
						...
						<div class="form-grids row widget-shadow" data-example-id="basic-forms">
							...
							<div class="form-body">
								<form method="post">
									...
									<?php
									$adminid = $_SESSION['bpmsaid'];
									$ret = mysqli_query($con, "select * from tblsalon where ID='$adminid'");
									$cnt = 1;
									while ($row = mysqli_fetch_array($ret)) {

									?>
										<div class="form-group"> <label for="exampleInputEmail1">Admin Name</label> <input type="text" class="form-control" id="adminname" name="adminname" placeholder="Admin Name" value="<?php echo $row['SalonAdminName']; ?>"> </div>
