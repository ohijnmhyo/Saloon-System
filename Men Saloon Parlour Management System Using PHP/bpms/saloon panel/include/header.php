...
<div class="sticky-header header-section ">
  ...
  <div class="header-right">
    <div class="profile_details_left"><!--notifications of menu start -->
      <ul class="nofitications-dropdown">
        ...
        <li class="dropdown head-dpdn">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-bell" style="color: black;"></i><span class="badge blue"><?php echo $num; ?></span></a>
    ...
    <div class="profile_details">
      ...
      $ret = mysqli_query($con, "select SalonAdminName from tblsalon where ID='$adid'");
      $row = mysqli_fetch_array($ret);
      $name = $row['SalonAdminName'];
        ...
        <li class="dropdown profile_details_drop">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
            <div class="profile_img">
              ...
              <div class="user-name">
                <p><?php echo $name; ?></p>
                <span>Saloon Administrator</span>
              </div>
