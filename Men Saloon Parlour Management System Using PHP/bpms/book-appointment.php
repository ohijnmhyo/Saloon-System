...
if (strlen($_SESSION['bpmsuid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "insert into tblbook(UserID,appointment_id,AptNumber,AptDate,AptTime,Message) value('$uid',$slug,'$aptnumber','$adate','$atime','$msg')");
...
?>
    ...
    <head>
        ...
        <title>Men Saloon System | Appointment Page</title>
