...
<head>
  ...
  <title>Men Saloon Management System | Home Page</title>
      ...
      <section class="slide slide-one">
        <div class="container">
          <div class="banner-text">
            ...
            <!-- <a href="book-appointment.php" class="btn logo-button top-margin" style="color: black;">Get An Appointment</a> -->
            <!-- <a href="" class="btn logo-button top-margin">Get An Appointment</a> -->
          </div>
        </div>
        ...
        <div class="grids">
          <div class="grids-content row">
            ...
            <div class="column col-lg-4 col-md-6 col-sm-6 back-image  ">
              <img src="assets/images/pexels-mati-mango-2528695.jpg" alt="product" class="img-responsive ">
            </div>
    ...
    <div class="team-single-main ">
      <div class="container">
        ...
        <div class="column2 image-text">
          ...
          <!-- <a href="book-appointment.php" class="btn logo-button top-margin mt-4" style="color: black;">Get An Appointment</a> -->
          <!-- <a href="" class="btn logo-button top-margin mt-4">Get An Appointment</a> -->
        </div>
      </div>
    </div>
    </div>
